...
<?php echo $this->Form->create('GoldmallPlayer'); ?>
	<fieldset>
		<legend><?php echo __('Edit Goldmall Player'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('GoldmallPlayer.id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('GoldmallPlayer.id'))); ?></li>
