...
<a href="/coinsets/all_change/<?php echo $coinsetId;?>/palette_color:<?php echo $paletteColor;?>/all_color:<?php echo $i;?>">
...
팔레트 선택 : 
<?php for ($i=0;$i<count($coinStyles);$i++):?>
<a href="/coinsets/custom/<?php echo $coinsetId;?>/palette_color:<?php echo $i;?>">
...
?>
<a href="/coinsets/change/<?php echo $coinsetId;?>/order:<?php echo $i?>/palette_color:<?php echo $paletteColor;?>">
